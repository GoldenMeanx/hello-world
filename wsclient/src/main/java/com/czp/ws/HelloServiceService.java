 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://ws.czp.com/", wsdlLocation = "http://localhost:8080/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://ws.czp.com/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://ws.czp.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.czp.com/", "HelloServicePort"), HelloService.class, features);
    }
